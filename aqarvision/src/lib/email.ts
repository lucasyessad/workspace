...
const templates = {
  ...
  bienvenue: (nomAgence: string) => ({
    subject: `Bienvenue sur AqarVision, ${nomAgence} !`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f7fafc;">
          <h2 style="color: #1a202c;">Bienvenue, ${nomAgence} !</h2>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f7fafc;">
          ...
          <p>Un prospect a contacté votre agence <strong>${params.nomAgence}</strong> :</p>
          <div style="background: white; padding: 15px; border-radius: 8px; border-left: 4px solid #d4af37;">
            <p><strong>Annonce :</strong> ${params.titreAnnonce}</p>
            <p><strong>Type :</strong> ${params.typeContact}</p>
            <p><strong>Prospect :</strong> ${params.nomProspect || "Anonyme"}</p>
            ${params.telProspect ? `<p><strong>Téléphone :</strong> ${params.telProspect}</p>` : ""}
          </div>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f7fafc;">
          ...
          <p>Le document soumis pour <strong>"${params.titreAnnonce}"</strong> a été
  ...
  trial_expiring: (nomAgence: string, joursRestants: number) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f7fafc;">
          <h2 style="color: #1a202c;">${nomAgence}, votre essai expire bientôt</h2>
