...
const fieldsMap: Record<number, FormField[]> = {
  ...
  4: [
    ...
    { id: "deductions", label: "Déductions actuelles", type: "textarea", placeholder: "Déductions fiscales actuellement utilisées..." },
  ],
  5: [
    ...
    { id: "extra_remboursement", label: "Argent supplémentaire disponible pour rembourser", type: "number", placeholder: "500", suffix: "€/mois" },
  ],
  6: [
  ...
  9: [
    ...
    { id: "lieu_residence", label: "Lieu de résidence", type: "text", placeholder: "Paris, France" },
    { id: "souhaits", label: "Souhaits pour la transmission", type: "textarea", placeholder: "Répartition souhaitée, dons de son vivant..." },
  ],
  10: [
    ...
    { id: "objectifs_investissement", label: "Objectifs d'investissement", type: "textarea", placeholder: "Rendement locatif, plus-value, défiscalisation..." },
  ],
  11: [
    { id: "revenu_mensuel", label: "Revenu mensuel net", type: "number", placeholder: "4000", suffix: "€" },
    { id: "depenses_detaillees", label: "Toutes les dépenses détaillées", type: "textarea", placeholder: "Loyer: 1200€, Alimentation: 400€, Transport: 150€..." },
    { id: "dettes_cours", label: "Dettes en cours", type: "textarea", placeholder: "Crédit immobilier, crédit conso..." },
    { id: "objectifs_epargne", label: "Objectifs d'épargne", type: "textarea", placeholder: "Vacances, voiture, apport immobilier..." },
    { id: "habitudes", label: "Habitudes de dépenses à changer", type: "textarea", placeholder: "Restaurants trop fréquents, abonnements inutiles..." },
  ],
  12: [
    { id: "age", label: "Âge", type: "number", placeholder: "35" },
    { id: "revenus_annuels", label: "Revenus annuels", type: "number", placeholder: "60000", suffix: "€" },
    { id: "patrimoine_net", label: "Patrimoine net actuel", type: "number", placeholder: "100000", suffix: "€" },
    { id: "projets_familiaux", label: "Projets familiaux", type: "textarea", placeholder: "Mariage, enfants, achat immobilier..." },
    { id: "trajectoire_carriere", label: "Trajectoire de carrière", type: "textarea", placeholder: "Évolution prévue, changement de poste..." },
    { id: "objectifs_financiers", label: "Plus grands objectifs financiers", type: "textarea", placeholder: "Indépendance financière, immobilier locatif..." },
    { id: "liberte_financiere", label: "Ce que signifie la liberté financière pour vous", type: "textarea", placeholder: "Ne plus avoir besoin de travailler, voyager..." },
  ],
};
